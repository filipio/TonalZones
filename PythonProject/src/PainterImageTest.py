...
class QImageViewer(QMainWindow):
    def __init__(self):
        ...
        self.imageLabel.setScaledContents(True) # if this guy is set to True, the actual content of an image
        # is getting larger when we increase the size of it 
    ...
    def print_(self): # it's like printing with a printer, a device
    ...
    def scaleImage(self, factor):
        ...
        self.scrollArea.verticalScrollBar().pageStep()
